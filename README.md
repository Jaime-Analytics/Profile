...
- Operations & Admin: Scheduling, budgeting, vendor management, reporting, process documentation
...
- Designed Power BI dashboards for a real‑world client scenario to support operational and financial decisions.
- Led ETL, SQL queries, and data modeling to deliver clean, analysis‑ready datasets.
- Worked with stakeholders to clarify requirements and present insights under tight timelines

## Work Experience
### Operations & Property Manager | Business Intelligence Analyst @ Eco Friendly Summit *(May 2017 - Present)* 
- Managed daily operations across housekeeping, maintenance, and guest services while serving as the primary client contact for communication, coordination, and issue resolution.
- Built KPI tracking systems and automated workflows using Excel Power Query and Google Workspace, improving planning, forecasting, and operational visibility.
- Led customer acquisition and long‑term relationship management through site visits, tailored service plans, and a people‑first communication approach.
- Supported major business growth by contributing to budgeting, forecasting, digital marketing strategies, and the creation of SOPs and onboarding materials for scalable operations.

### Front Desk Associate | Guest Services & Administration @ The Grand Canadian Resort Vacation Club *(July 2023 - February 2025)*
- Supported members and guests with reservations, check‑ins/outs, service inquiries, and daily administrative tasks (payments, documentation, scheduling, reporting) to keep operations organized and running smoothly.
- Coordinated with housekeeping and maintenance teams to resolve issues quickly and strengthened guest satisfaction through clear communication, problem‑solving, and a consistent people‑first approach.
